...
USE [AP]
GO
/****** Object:  User [MartinRey]    Script Date: 07/16/2013 14:39:11 ******/
CREATE USER [MartinRey] WITHOUT LOGIN WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Table [dbo].[InvoiceArchive]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[GLAccounts]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[ContactUpdates]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Terms]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Vendors]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[Invoices]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (1, 122, N'989319-457', CAST(0x9A780000 AS SmallDateTime), 3813.3300, 3813.3300, 0.0000, 3, CAST(0x9A960000 AS SmallDateTime), CAST(0x9A950000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (2, 123, N'263253241', CAST(0x9A7A0000 AS SmallDateTime), 40.2000, 40.2000, 0.0000, 3, CAST(0x9A980000 AS SmallDateTime), CAST(0x9A9C0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (3, 123, N'963253234', CAST(0x9A7D0000 AS SmallDateTime), 138.7500, 138.7500, 0.0000, 3, CAST(0x9A9B0000 AS SmallDateTime), CAST(0x9A970000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (4, 123, N'2-000-2993', CAST(0x9A800000 AS SmallDateTime), 144.7000, 144.7000, 0.0000, 3, CAST(0x9A9E0000 AS SmallDateTime), CAST(0x9A9A0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (5, 123, N'963253251', CAST(0x9A800000 AS SmallDateTime), 15.5000, 15.5000, 0.0000, 3, CAST(0x9A9E0000 AS SmallDateTime), CAST(0x9A990000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (6, 123, N'963253261', CAST(0x9A800000 AS SmallDateTime), 42.7500, 42.7500, 0.0000, 3, CAST(0x9A9E0000 AS SmallDateTime), CAST(0x9AA30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (7, 123, N'963253237', CAST(0x9A850000 AS SmallDateTime), 172.5000, 172.5000, 0.0000, 3, CAST(0x9AA30000 AS SmallDateTime), CAST(0x9AA40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (8, 89, N'125520-1', CAST(0x9A880000 AS SmallDateTime), 95.0000, 95.0000, 0.0000, 1, CAST(0x9A920000 AS SmallDateTime), CAST(0x9A8F0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (9, 121, N'97/488', CAST(0x9A880000 AS SmallDateTime), 601.9500, 601.9500, 0.0000, 3, CAST(0x9AA60000 AS SmallDateTime), CAST(0x9AA30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (10, 123, N'263253250', CAST(0x9A880000 AS SmallDateTime), 42.6700, 42.6700, 0.0000, 3, CAST(0x9AA60000 AS SmallDateTime), CAST(0x9AA40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (11, 123, N'963253262', CAST(0x9A890000 AS SmallDateTime), 42.5000, 42.5000, 0.0000, 3, CAST(0x9AA70000 AS SmallDateTime), CAST(0x9AA20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (12, 96, N'I77271-O01', CAST(0x9A8A0000 AS SmallDateTime), 662.0000, 662.0000, 0.0000, 2, CAST(0x9A9E0000 AS SmallDateTime), CAST(0x9A9B0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (13, 95, N'111-92R-10096', CAST(0x9A8E0000 AS SmallDateTime), 16.3300, 16.3300, 0.0000, 2, CAST(0x9AA20000 AS SmallDateTime), CAST(0x9AA50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (14, 115, N'25022117', CAST(0x9A8F0000 AS SmallDateTime), 6.0000, 6.0000, 0.0000, 4, CAST(0x9AB70000 AS SmallDateTime), CAST(0x9AB70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (15, 48, N'P02-88D77S7', CAST(0x9A910000 AS SmallDateTime), 856.9200, 856.9200, 0.0000, 3, CAST(0x9AAF0000 AS SmallDateTime), CAST(0x9AAC0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (16, 97, N'21-4748363', CAST(0x9A910000 AS SmallDateTime), 9.9500, 9.9500, 0.0000, 2, CAST(0x9AA50000 AS SmallDateTime), CAST(0x9AA40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (17, 123, N'4-321-2596', CAST(0x9A930000 AS SmallDateTime), 10.0000, 10.0000, 0.0000, 3, CAST(0x9AB10000 AS SmallDateTime), CAST(0x9AB20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (18, 123, N'963253242', CAST(0x9A940000 AS SmallDateTime), 104.0000, 104.0000, 0.0000, 3, CAST(0x9AB20000 AS SmallDateTime), CAST(0x9AB20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (19, 34, N'QP58872', CAST(0x9A950000 AS SmallDateTime), 116.5400, 116.5400, 0.0000, 1, CAST(0x9A9F0000 AS SmallDateTime), CAST(0x9AA10000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (20, 115, N'24863706', CAST(0x9A980000 AS SmallDateTime), 6.0000, 6.0000, 0.0000, 4, CAST(0x9AC00000 AS SmallDateTime), CAST(0x9ABC0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (21, 119, N'10843', CAST(0x9A990000 AS SmallDateTime), 4901.2600, 4901.2600, 0.0000, 2, CAST(0x9AAD0000 AS SmallDateTime), CAST(0x9AAB0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (22, 123, N'963253235', CAST(0x9A990000 AS SmallDateTime), 108.2500, 108.2500, 0.0000, 3, CAST(0x9AB70000 AS SmallDateTime), CAST(0x9AB60000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (23, 97, N'21-4923721', CAST(0x9A9B0000 AS SmallDateTime), 9.9500, 9.9500, 0.0000, 2, CAST(0x9AAF0000 AS SmallDateTime), CAST(0x9AAA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (24, 113, N'77290', CAST(0x9A9B0000 AS SmallDateTime), 1750.0000, 1750.0000, 0.0000, 5, CAST(0x9ACD0000 AS SmallDateTime), CAST(0x9AD00000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (25, 123, N'963253246', CAST(0x9A9B0000 AS SmallDateTime), 129.0000, 129.0000, 0.0000, 3, CAST(0x9AB90000 AS SmallDateTime), CAST(0x9AB60000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (26, 123, N'4-342-8069', CAST(0x9A9C0000 AS SmallDateTime), 10.0000, 10.0000, 0.0000, 3, CAST(0x9ABA0000 AS SmallDateTime), CAST(0x9ABA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (27, 88, N'972110', CAST(0x9A9D0000 AS SmallDateTime), 207.7800, 207.7800, 0.0000, 1, CAST(0x9AA70000 AS SmallDateTime), CAST(0x9AA90000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (28, 123, N'963253263', CAST(0x9A9E0000 AS SmallDateTime), 109.5000, 109.5000, 0.0000, 3, CAST(0x9ABC0000 AS SmallDateTime), CAST(0x9AB70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (29, 108, N'121897', CAST(0x9AA10000 AS SmallDateTime), 450.0000, 450.0000, 0.0000, 4, CAST(0x9AC90000 AS SmallDateTime), CAST(0x9ACE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (30, 123, N'1-200-5164', CAST(0x9AA20000 AS SmallDateTime), 63.4000, 63.4000, 0.0000, 3, CAST(0x9AC00000 AS SmallDateTime), CAST(0x9AC50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (31, 104, N'P02-3772', CAST(0x9AA30000 AS SmallDateTime), 7125.3400, 7125.3400, 0.0000, 3, CAST(0x9AC10000 AS SmallDateTime), CAST(0x9AC50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (32, 121, N'97/486', CAST(0x9AA30000 AS SmallDateTime), 953.1000, 953.1000, 0.0000, 3, CAST(0x9AC10000 AS SmallDateTime), CAST(0x9AC30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (33, 105, N'94007005', CAST(0x9AA50000 AS SmallDateTime), 220.0000, 220.0000, 0.0000, 3, CAST(0x9AC30000 AS SmallDateTime), CAST(0x9AC70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (34, 123, N'963253232', CAST(0x9AA50000 AS SmallDateTime), 127.7500, 127.7500, 0.0000, 3, CAST(0x9AC30000 AS SmallDateTime), CAST(0x9ABF0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (35, 107, N'RTR-72-3662-X', CAST(0x9AA70000 AS SmallDateTime), 1600.0000, 1600.0000, 0.0000, 4, CAST(0x9ACF0000 AS SmallDateTime), CAST(0x9AD40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (36, 121, N'97/465', CAST(0x9AA70000 AS SmallDateTime), 565.1500, 565.1500, 0.0000, 3, CAST(0x9AC50000 AS SmallDateTime), CAST(0x9AC50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (37, 123, N'963253260', CAST(0x9AA70000 AS SmallDateTime), 36.0000, 36.0000, 0.0000, 3, CAST(0x9AC50000 AS SmallDateTime), CAST(0x9AC70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (38, 123, N'963253272', CAST(0x9AA80000 AS SmallDateTime), 61.5000, 61.5000, 0.0000, 3, CAST(0x9AC60000 AS SmallDateTime), CAST(0x9ACB0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (39, 110, N'0-2058', CAST(0x9AAA0000 AS SmallDateTime), 37966.1900, 37966.1900, 0.0000, 3, CAST(0x9AC80000 AS SmallDateTime), CAST(0x9ACB0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (40, 121, N'97/503', CAST(0x9AAC0000 AS SmallDateTime), 639.7700, 639.7700, 0.0000, 3, CAST(0x9ACA0000 AS SmallDateTime), CAST(0x9AC60000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (41, 123, N'963253255', CAST(0x9AAD0000 AS SmallDateTime), 53.7500, 53.7500, 0.0000, 3, CAST(0x9ACB0000 AS SmallDateTime), CAST(0x9AC80000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (42, 123, N'94007069', CAST(0x9AAD0000 AS SmallDateTime), 400.0000, 400.0000, 0.0000, 3, CAST(0x9ACB0000 AS SmallDateTime), CAST(0x9ACC0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (43, 72, N'40318', CAST(0x9AAE0000 AS SmallDateTime), 21842.0000, 21842.0000, 0.0000, 3, CAST(0x9ACC0000 AS SmallDateTime), CAST(0x9ACA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (44, 95, N'111-92R-10094', CAST(0x9AAE0000 AS SmallDateTime), 19.6700, 19.6700, 0.0000, 2, CAST(0x9AC20000 AS SmallDateTime), CAST(0x9AC50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (45, 122, N'989319-437', CAST(0x9AAE0000 AS SmallDateTime), 2765.3600, 2765.3600, 0.0000, 3, CAST(0x9ACC0000 AS SmallDateTime), CAST(0x9AC90000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (46, 37, N'547481328', CAST(0x9AB00000 AS SmallDateTime), 224.0000, 224.0000, 0.0000, 3, CAST(0x9ACE0000 AS SmallDateTime), CAST(0x9ACF0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (47, 83, N'31359783', CAST(0x9AB00000 AS SmallDateTime), 1575.0000, 1575.0000, 0.0000, 2, CAST(0x9AC40000 AS SmallDateTime), CAST(0x9AC20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (48, 123, N'1-202-2978', CAST(0x9AB00000 AS SmallDateTime), 33.0000, 33.0000, 0.0000, 3, CAST(0x9ACE0000 AS SmallDateTime), CAST(0x9AD00000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (49, 95, N'111-92R-10097', CAST(0x9AB10000 AS SmallDateTime), 16.3300, 16.3300, 0.0000, 2, CAST(0x9AC50000 AS SmallDateTime), CAST(0x9AC70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (50, 37, N'547479217', CAST(0x9AB40000 AS SmallDateTime), 116.0000, 116.0000, 0.0000, 3, CAST(0x9AD20000 AS SmallDateTime), CAST(0x9AD20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (51, 122, N'989319-477', CAST(0x9AB50000 AS SmallDateTime), 2184.1100, 2184.1100, 0.0000, 3, CAST(0x9AD30000 AS SmallDateTime), CAST(0x9AD30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (52, 34, N'Q545443', CAST(0x9AB60000 AS SmallDateTime), 1083.5800, 1083.5800, 0.0000, 1, CAST(0x9AC00000 AS SmallDateTime), CAST(0x9AC40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (53, 95, N'111-92R-10092', CAST(0x9AB60000 AS SmallDateTime), 46.2100, 46.2100, 0.0000, 2, CAST(0x9ACA0000 AS SmallDateTime), CAST(0x9ACD0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (54, 121, N'97/553B', CAST(0x9AB70000 AS SmallDateTime), 313.5500, 313.5500, 0.0000, 3, CAST(0x9AD50000 AS SmallDateTime), CAST(0x9AD40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (55, 123, N'963253245', CAST(0x9AB70000 AS SmallDateTime), 40.7500, 40.7500, 0.0000, 3, CAST(0x9AD50000 AS SmallDateTime), CAST(0x9AD70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (56, 86, N'367447', CAST(0x9AB80000 AS SmallDateTime), 2433.0000, 2433.0000, 0.0000, 1, CAST(0x9AC20000 AS SmallDateTime), CAST(0x9ABE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (57, 103, N'75C-90227', CAST(0x9AB80000 AS SmallDateTime), 1367.5000, 1367.5000, 0.0000, 5, CAST(0x9AEA0000 AS SmallDateTime), CAST(0x9AEA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (58, 123, N'963253256', CAST(0x9AB80000 AS SmallDateTime), 53.2500, 53.2500, 0.0000, 3, CAST(0x9AD60000 AS SmallDateTime), CAST(0x9AD20000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (59, 123, N'4-314-3057', CAST(0x9AB80000 AS SmallDateTime), 13.7500, 13.7500, 0.0000, 3, CAST(0x9AD60000 AS SmallDateTime), CAST(0x9ADA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (60, 122, N'989319-497', CAST(0x9AB90000 AS SmallDateTime), 2312.2000, 2312.2000, 0.0000, 3, CAST(0x9AD70000 AS SmallDateTime), CAST(0x9AD40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (61, 115, N'24946731', CAST(0x9ABC0000 AS SmallDateTime), 25.6700, 25.6700, 0.0000, 4, CAST(0x9AE40000 AS SmallDateTime), CAST(0x9AE50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (62, 123, N'963253269', CAST(0x9ABC0000 AS SmallDateTime), 26.7500, 26.7500, 0.0000, 3, CAST(0x9ADA0000 AS SmallDateTime), CAST(0x9AD60000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (63, 122, N'989319-427', CAST(0x9ABD0000 AS SmallDateTime), 2115.8100, 2115.8100, 0.0000, 3, CAST(0x9ADB0000 AS SmallDateTime), CAST(0x9ADE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (64, 123, N'963253267', CAST(0x9ABE0000 AS SmallDateTime), 23.5000, 23.5000, 0.0000, 3, CAST(0x9ADC0000 AS SmallDateTime), CAST(0x9ADE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (65, 99, N'509786', CAST(0x9ABF0000 AS SmallDateTime), 6940.2500, 6940.2500, 0.0000, 3, CAST(0x9ADD0000 AS SmallDateTime), CAST(0x9ADA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (66, 123, N'263253253', CAST(0x9ABF0000 AS SmallDateTime), 31.9500, 31.9500, 0.0000, 3, CAST(0x9ADD0000 AS SmallDateTime), CAST(0x9AE00000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (67, 122, N'989319-487', CAST(0x9AC10000 AS SmallDateTime), 1927.5400, 1927.5400, 0.0000, 3, CAST(0x9ADF0000 AS SmallDateTime), CAST(0x9ADD0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (68, 81, N'MABO1489', CAST(0x9AC20000 AS SmallDateTime), 936.9300, 936.9300, 0.0000, 2, CAST(0x9AD60000 AS SmallDateTime), CAST(0x9AD50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (69, 80, N'133560', CAST(0x9AC30000 AS SmallDateTime), 175.0000, 175.0000, 0.0000, 2, CAST(0x9AD70000 AS SmallDateTime), CAST(0x9ADB0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (70, 115, N'24780512', CAST(0x9AC30000 AS SmallDateTime), 6.0000, 6.0000, 0.0000, 4, CAST(0x9AEB0000 AS SmallDateTime), CAST(0x9AE80000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (71, 123, N'963253254', CAST(0x9AC30000 AS SmallDateTime), 108.5000, 108.5000, 0.0000, 3, CAST(0x9AE10000 AS SmallDateTime), CAST(0x9ADF0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (72, 123, N'43966316', CAST(0x9AC30000 AS SmallDateTime), 10.0000, 10.0000, 0.0000, 3, CAST(0x9AE10000 AS SmallDateTime), CAST(0x9ADC0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (73, 114, N'CBM9920-M-T77109', CAST(0x9AC40000 AS SmallDateTime), 290.0000, 290.0000, 0.0000, 1, CAST(0x9ACE0000 AS SmallDateTime), CAST(0x9ACA0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (74, 102, N'109596', CAST(0x9AC50000 AS SmallDateTime), 41.8000, 41.8000, 0.0000, 4, CAST(0x9AED0000 AS SmallDateTime), CAST(0x9AEE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (75, 123, N'7548906-20', CAST(0x9AC50000 AS SmallDateTime), 27.0000, 27.0000, 0.0000, 3, CAST(0x9AE30000 AS SmallDateTime), CAST(0x9AE30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (76, 123, N'963253248', CAST(0x9AC50000 AS SmallDateTime), 241.0000, 241.0000, 0.0000, 3, CAST(0x9AE30000 AS SmallDateTime), CAST(0x9AE40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (77, 121, N'97/553', CAST(0x9AC60000 AS SmallDateTime), 904.1400, 904.1400, 0.0000, 3, CAST(0x9AE40000 AS SmallDateTime), CAST(0x9AE40000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (78, 121, N'97/522', CAST(0x9AC90000 AS SmallDateTime), 1962.1300, 1762.1300, 200.0000, 3, CAST(0x9AE70000 AS SmallDateTime), CAST(0x9AE90000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (79, 100, N'587056', CAST(0x9ACB0000 AS SmallDateTime), 2184.5000, 2184.5000, 0.0000, 4, CAST(0x9AF30000 AS SmallDateTime), CAST(0x9AF10000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (80, 122, N'989319-467', CAST(0x9ACC0000 AS SmallDateTime), 2318.0300, 2318.0300, 0.0000, 3, CAST(0x9AEA0000 AS SmallDateTime), CAST(0x9AE80000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (81, 123, N'263253265', CAST(0x9ACD0000 AS SmallDateTime), 26.2500, 26.2500, 0.0000, 3, CAST(0x9AEB0000 AS SmallDateTime), CAST(0x9AE70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (82, 94, N'203339-13', CAST(0x9AD00000 AS SmallDateTime), 17.5000, 17.5000, 0.0000, 2, CAST(0x9AE40000 AS SmallDateTime), CAST(0x9AE60000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (83, 95, N'111-92R-10093', CAST(0x9AD10000 AS SmallDateTime), 39.7700, 39.7700, 0.0000, 2, CAST(0x9AE50000 AS SmallDateTime), CAST(0x9AE10000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (84, 123, N'963253258', CAST(0x9AD10000 AS SmallDateTime), 111.0000, 111.0000, 0.0000, 3, CAST(0x9AEF0000 AS SmallDateTime), CAST(0x9AEF0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (85, 123, N'963253271', CAST(0x9AD20000 AS SmallDateTime), 158.0000, 158.0000, 0.0000, 3, CAST(0x9AF00000 AS SmallDateTime), CAST(0x9AF50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (86, 123, N'963253230', CAST(0x9AD20000 AS SmallDateTime), 739.2000, 739.2000, 0.0000, 3, CAST(0x9AF00000 AS SmallDateTime), CAST(0x9AF00000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (87, 123, N'963253244', CAST(0x9AD30000 AS SmallDateTime), 60.0000, 60.0000, 0.0000, 3, CAST(0x9AF10000 AS SmallDateTime), CAST(0x9AF30000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (88, 123, N'963253239', CAST(0x9AD30000 AS SmallDateTime), 147.2500, 147.2500, 0.0000, 3, CAST(0x9AF10000 AS SmallDateTime), CAST(0x9AF50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (89, 72, N'39104', CAST(0x9AD50000 AS SmallDateTime), 85.3100, 0.0000, 0.0000, 3, CAST(0x9AF30000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (90, 123, N'963253252', CAST(0x9AD70000 AS SmallDateTime), 38.7500, 38.7500, 0.0000, 3, CAST(0x9AF50000 AS SmallDateTime), CAST(0x9AF50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (91, 95, N'111-92R-10095', CAST(0x9ADA0000 AS SmallDateTime), 32.7000, 32.7000, 0.0000, 2, CAST(0x9AEE0000 AS SmallDateTime), CAST(0x9AF00000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (92, 117, N'111897', CAST(0x9ADA0000 AS SmallDateTime), 16.6200, 16.6200, 0.0000, 3, CAST(0x9AF80000 AS SmallDateTime), CAST(0x9AF80000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (93, 123, N'4-327-7357', CAST(0x9ADB0000 AS SmallDateTime), 162.7500, 162.7500, 0.0000, 3, CAST(0x9AF90000 AS SmallDateTime), CAST(0x9AF50000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (94, 123, N'963253264', CAST(0x9ADD0000 AS SmallDateTime), 52.2500, 0.0000, 0.0000, 3, CAST(0x9AFB0000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (95, 82, N'C73-24', CAST(0x9ADE0000 AS SmallDateTime), 600.0000, 600.0000, 0.0000, 2, CAST(0x9AF20000 AS SmallDateTime), CAST(0x9AF70000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (96, 110, N'P-0259', CAST(0x9ADE0000 AS SmallDateTime), 26881.4000, 26881.4000, 0.0000, 3, CAST(0x9AFC0000 AS SmallDateTime), CAST(0x9AFE0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (97, 90, N'97-1024A', CAST(0x9ADF0000 AS SmallDateTime), 356.4800, 356.4800, 0.0000, 2, CAST(0x9AF30000 AS SmallDateTime), CAST(0x9AF10000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (98, 83, N'31361833', CAST(0x9AE00000 AS SmallDateTime), 579.4200, 0.0000, 0.0000, 2, CAST(0x9AF40000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (99, 123, N'263253268', CAST(0x9AE00000 AS SmallDateTime), 59.9700, 0.0000, 0.0000, 3, CAST(0x9AFE0000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (100, 123, N'263253270', CAST(0x9AE10000 AS SmallDateTime), 67.9200, 0.0000, 0.0000, 3, CAST(0x9AFF0000 AS SmallDateTime), NULL)
GO
print 'Processed 100 total records'
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (101, 123, N'263253273', CAST(0x9AE10000 AS SmallDateTime), 30.7500, 0.0000, 0.0000, 3, CAST(0x9AFF0000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (102, 110, N'P-0608', CAST(0x9AE20000 AS SmallDateTime), 20551.1800, 0.0000, 1200.0000, 3, CAST(0x9B000000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (103, 122, N'989319-417', CAST(0x9AE20000 AS SmallDateTime), 2051.5900, 2051.5900, 0.0000, 3, CAST(0x9B000000 AS SmallDateTime), CAST(0x9B020000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (104, 123, N'263253243', CAST(0x9AE20000 AS SmallDateTime), 44.4400, 44.4400, 0.0000, 3, CAST(0x9B000000 AS SmallDateTime), CAST(0x9B020000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (105, 106, N'9982771', CAST(0x9AE30000 AS SmallDateTime), 503.2000, 0.0000, 0.0000, 3, CAST(0x9B010000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (106, 110, N'0-2060', CAST(0x9AE30000 AS SmallDateTime), 23517.5800, 21221.6300, 2295.9500, 3, CAST(0x9B010000 AS SmallDateTime), CAST(0x9B050000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (107, 122, N'989319-447', CAST(0x9AE30000 AS SmallDateTime), 3689.9900, 3689.9900, 0.0000, 3, CAST(0x9B010000 AS SmallDateTime), CAST(0x9AFD0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (108, 123, N'963253240', CAST(0x9AE30000 AS SmallDateTime), 67.0000, 67.0000, 0.0000, 3, CAST(0x9B010000 AS SmallDateTime), CAST(0x9B010000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (109, 121, N'97/222', CAST(0x9AE40000 AS SmallDateTime), 1000.4600, 1000.4600, 0.0000, 3, CAST(0x9B020000 AS SmallDateTime), CAST(0x9B000000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (110, 80, N'134116', CAST(0x9AE70000 AS SmallDateTime), 90.3600, 0.0000, 0.0000, 2, CAST(0x9AFB0000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (111, 123, N'263253257', CAST(0x9AE90000 AS SmallDateTime), 22.5700, 22.5700, 0.0000, 3, CAST(0x9B070000 AS SmallDateTime), CAST(0x9B0C0000 AS SmallDateTime))
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (112, 110, N'0-2436', CAST(0x9AEA0000 AS SmallDateTime), 10976.0600, 0.0000, 0.0000, 3, CAST(0x9B080000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (113, 37, N'547480102', CAST(0x9AEB0000 AS SmallDateTime), 224.0000, 0.0000, 0.0000, 3, CAST(0x9B090000 AS SmallDateTime), NULL)
INSERT [dbo].[Invoices] ([InvoiceID], [VendorID], [InvoiceNumber], [InvoiceDate], [InvoiceTotal], [PaymentTotal], [CreditTotal], [TermsID], [InvoiceDueDate], [PaymentDate]) VALUES (114, 123, N'963253249', CAST(0x9AEC0000 AS SmallDateTime), 127.7500, 127.7500, 0.0000, 3, CAST(0x9B0A0000 AS SmallDateTime), CAST(0x9B0D0000 AS SmallDateTime))
SET IDENTITY_INSERT [dbo].[Invoices] OFF
/****** Object:  Table [dbo].[InvoiceLineItems]    Script Date: 07/16/2013 14:39:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  ForeignKey [FK_InvoiceLineItems_Invoices]    Script Date: 07/16/2013 14:39:11 ******/
...
GO
/****** Object:  ForeignKey [FK_Invoices_Terms]    Script Date: 07/16/2013 14:39:11 ******/
...
GO
/****** Object:  ForeignKey [FK_Invoices_Vendors]    Script Date: 07/16/2013 14:39:11 ******/
...
GO
/****** Object:  ForeignKey [FK_Vendors_GLAccounts]    Script Date: 07/16/2013 14:39:11 ******/
...
GO
/****** Object:  ForeignKey [FK_Vendors_Terms]    Script Date: 07/16/2013 14:39:11 ******/
...
SELECT*FROM dbo.ContactUpdates
...
--- cau1: tạo tài khoản --Use1: Có quyền tạo và chỉnh sửa bảng
SP_addlogin 'user1', 'v06052002'

-- c2: 
CREATE LOGIN user1 WITH PASSWORD = 'v06052002';

--- tạo tên người dùng
SP_addUser 'user1','DANGDINHVU';

--C2:
CREATE USER DANGDINHVU FOR LOGIN user1;

-- CẤP QUYỀN TẠO BẢNG VÀ CHỈNH SỬA BẢNG
GRANT ALTER, UPDATE ON dbo.ContactUpdates TO USER1

-- Use2: Chỉ có quyền xem không sửa được
-- TẠO TAIKHOAN
SP_ADDLOGIN 'user2', 'v06052002';

--C2:
CREATE LOGIN user2 WITH PASSWORD = 'v06052002'

-- TẠO NGƯỜI DÙNG (USER2)
SP_addUser 'user2', 'DANGDINHVU2';

--C2:
CREATE USER USER2 FOR LOGIN DANGDINHVU2

-- CẤP QUYỀN XEM KHÔNG ĐƯỢC SỬA
GRANT SELECT ON dbo.ContactUpdates TO USER2 
DENY UPDATE ON dbo.ContactUpdates TO USER2

-- hiển thị thông tin pemissions
SP_helprotect ContactUpdates
